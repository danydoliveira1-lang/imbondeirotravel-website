...
const destinations = {
  kalandula: {
    ...
    lng: 16.0003, lat: -9.0722, image: "/assets/highlight-kalandula.jpg", duration: "2–3 days",
  ...
  miradouro: {
    ...
    lng: 13.1880, lat: -9.2190, image: "/assets/miradouro-da-lua-approved.jpg", duration: "Half day",
  ...
  kwanza: {
    id: "kwanza", title: "Kwanza River / Barra do Kwanza", province: "Luanda Province", category: "Nature",
    lng: 13.1590, lat: -9.3530, image: "/assets/kwanza-river-boat.png", duration: "Full day",
  ...
  mbanzaCulture: {
    ...
    lng: 14.2400, lat: -6.2670, image: "/assets/mbanza-kongo-approved.jpg", duration: "2–3 days",
  ...
  luandaCity: {
    ...
    lng: 13.2344, lat: -8.8383, image: "/assets/highlight-luanda.jpg", duration: "Half or full day",
  ...
  mufete: {
    ...
    lng: 13.2235, lat: -8.8055, image: "/assets/mufete-angolan-dish.png", duration: "Half or full day",
  ...
  dance: {
    id: "dance", title: "Traditional Angolan Dance", province: "Luanda Province", category: "Culture",
    lng: 13.2344, lat: -8.8383, image: "/assets/angolan-culture-dance.png", duration: "Tailored experience",
  ...
  kissama: {
    ...
    lng: 13.5833, lat: -9.7500, image: "/assets/highlight-kissama.jpg", duration: "Full day",
  ...
  benguelaCoast: {
    ...
    lng: 13.3347, lat: -12.6138, image: "/assets/benguela-coast-approved.webp", duration: "2–3 days",
  ...
  lobito: {
    ...
    lng: 13.5456, lat: -12.3597, image: "/assets/benguela-coast-approved.webp", duration: "1–2 days",
  ...
  cabo: {
    ...
    lng: 13.1965, lat: -9.6815, image: "/assets/cabo-ledo-angola.jpg", duration: "Full day or overnight",
  ...
  mussuloCoast: {
    ...
    lng: 13.0900, lat: -9.0450, image: "/assets/mussulo-luxury-island-escape.png", duration: "Full day",
  ...
  benguelaRomance: {
    ...
    lng: 13.3347, lat: -12.6138, image: "/assets/benguela-romance-approved.jpg", duration: "3 days",
  ...
  mussuloRomance: {
    ...
    lng: 13.0900, lat: -9.0450, image: "/assets/mussulo-luxury-island-escape.png", duration: "Full day or overnight",
  ...
  caboRomance: {
    id: "caboRomance", title: "Cabo Ledo for Two", province: "Icolo e Bengo Province", category: "Romance",
    lng: 13.1965, lat: -9.6815, image: "/assets/cabo-ledo-angola.jpg", duration: "Overnight",
  ...
  memorial: {
    ...
    lng: 13.2318, lat: -8.8219, image: "/assets/agostinho-neto-memorial-approved.jpg", duration: "Half day",
  ...
  fortaleza: {
    ...
    lng: 13.2254, lat: -8.8074, image: "/assets/fortaleza-sao-miguel-approved.jpg", duration: "Half day",
      ...
      <div className={`living-map mood-${choice.toLowerCase()}`} onPointerDown={down} onPointerMove={move} onPointerUp={up} onPointerCancel={up}>
        ...
        <div className="living-map-canvas" style={{transform:`translate(${pan.x}px,${pan.y}px) scale(${zoom})`}}>
          <svg viewBox={`0 0 ${MAP_W} ${MAP_H}`} preserveAspectRatio="xMidYMid meet"
              className="living-country" aria-label="Interactive map of Angola">
          ...
          {visibleIds.map(id=>{const d=destinations[id],active=selectedId===id,added=has(`destination:${id}`);return <button key={id} type="button" className={`living-marker ${active?"active":""} ${added?"added":""}`} style={markerStyle(d)} onPointerDown={(e)=>e.stopPropagation()} onPointerUp={(e)=>e.stopPropagation()} onClick={(e)=>{  e.preventDefault(); e.stopPropagation();setSelectedId(id);setStoryId(id); }} aria-label={`Explore ${d.title}`}><span className="pin"><i/></span><span className="marker-name">{d.title}<small>{d.province}</small></span></button>})}
        </div>

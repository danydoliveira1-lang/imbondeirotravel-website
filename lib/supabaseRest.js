const allowedTables = new Set(["tours", "departures", "reservations", "customers", "media", "payments"]);
...
export async function getAllCommandCentreData() {
  const sections = ["tours", "departures", "reservations", "customers", "media", "payments"];
